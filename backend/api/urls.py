...
urlpatterns = [
    ...
    path("cursos/<int:pk>/image/delete/<int:image_id>/", views.basic_delete_image, name="delete_image"),
    path("cursos/<int:pk>/image/upload/", views.basic_upload_image, name="upload_curso_image"),
